export const tables = {
  ...
  payments: {
    columns: ["id", "order_id", "user_id", "transaction_id", "payment_method", "payment_gateway", "amount", "status", "failure_reason", "refund_amount", "refunded_at", "created_at"],
    rows: [
      { id: 1, order_id: 1, user_id: 207, transaction_id: "TXN-abc123def456", payment_method: "upi",         payment_gateway: "razorpay", amount: "1599.00",  status: "pending",            failure_reason: null,            refund_amount: "0.00",    refunded_at: null,                    created_at: "2025-01-10 10:02:00" },
      { id: 2, order_id: 2, user_id: 208, transaction_id: "TXN-bcd234efg567", payment_method: "credit_card", payment_gateway: "stripe",   amount: "3499.00",  status: "success",            failure_reason: null,            refund_amount: "0.00",    refunded_at: null,                    created_at: "2025-02-14 11:32:00" },
      { id: 3, order_id: 3, user_id: 209, transaction_id: "TXN-cde345fgh678", payment_method: "debit_card",  payment_gateway: "paytm",    amount: "899.00",   status: "success",            failure_reason: null,            refund_amount: "0.00",    refunded_at: null,                    created_at: "2025-03-05 09:02:00" },
      { id: 4, order_id: 4, user_id: 210, transaction_id: "TXN-def456ghi789", payment_method: "netbanking",  payment_gateway: "cashfree", amount: "12800.00", status: "failed",             failure_reason: "Card declined", refund_amount: "0.00",    refunded_at: null,                    created_at: "2025-04-01 08:02:00" },
      { id: 5, order_id: 5, user_id: 211, transaction_id: "TXN-efg567hij890", payment_method: "wallet",      payment_gateway: "paypal",   amount: "5200.00",  status: "refunded",           failure_reason: null,            refund_amount: "5200.00", refunded_at: "2025-04-25 10:15:00", created_at: "2025-04-18 14:02:00" },
      { id: 6, order_id: 6, user_id: 212, transaction_id: "TXN-fgh678ijk901", payment_method: "cod",         payment_gateway: "paytm",    amount: "2100.00",  status: "partially_refunded", failure_reason: null,            refund_amount: "1050.00", refunded_at: "2025-05-28 09:30:00", created_at: "2025-05-22 10:02:00" },
      { id: 7, order_id: 7, user_id: 213, transaction_id: "TXN-ghi789jkl012", payment_method: "emi",         payment_gateway: "cashfree", amount: "4750.00",  status: "refunded",           failure_reason: null,            refund_amount: "4750.00", refunded_at: "2025-06-22 16:45:00", created_at: "2025-06-15 09:02:00" },
      { id: 8, order_id: 1, user_id: 207, transaction_id: "TXN-hij890klm123", payment_method: "netbanking",  payment_gateway: "razorpay", amount: "1599.00",  status: "success",            failure_reason: null,            refund_amount: "0.00",    refunded_at: null,                    created_at: "2025-01-10 10:05:00" },
    ],
  },
  shipments: {
